...
export default function SpecPlate({ compact = false }) {
  return (
    <div
      className={`relative min-w-0 max-w-full border border-concrete-300/40 bg-charcoal-950/80 backdrop-blur-[2px] font-mono text-paper ${
        compact ? "text-[11px] p-3 sm:text-xs sm:p-4" : "text-xs p-4 sm:text-sm sm:p-5"
      }`}
    >
      <CornerMarks inset="inset-1" />
